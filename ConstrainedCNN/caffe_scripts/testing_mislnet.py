...
caffe_root = '/home/qiaotong/caffe_hpfx3'


MODEL_FILE = '/home/qiaotong/ConstrainedCNN/caffe_scripts/deploy_mislnet.prototxt' #Make sure about the path where you saved your prototxt file
PRETRAINED = '/home/qiaotong/ConstrainedCNN/caffe_scripts/mislnet_six_classes.caffemodel' #Make sure about the path where you saved your caffe model
...
lmdb_env = lmdb.open('/home/qiaotong/ConstrainedCNN/caffe_scripts/test_lmdb/') #Make sure about the path where you saved the test_lmdb data

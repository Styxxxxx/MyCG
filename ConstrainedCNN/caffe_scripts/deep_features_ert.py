...
MODEL_FILE = '/home/belhassen/caffe_scripts/deploy_mislnet.prototxt'  #Make sure about the path where you saved your prototxt file
PRETRAINED = '/home/belhassen/caffe_scripts/mislnet_six_classes.caffemodel'  #Make sure about the path where you saved your caffe model
...
lmdb_env = lmdb.open('/home/belhassen/data/tifs_dresden_data/train_lmdb/')
...
lmdb_env = lmdb.open('/home/belhassen/data/tifs_dresden_data/test_lmdb/')
